        ...
        getDisplayValue: function () {
            ...
            if (this.isConceptNameChiefComplaintData()) {
                if (this.groupMembers[0].value.name !== this.translate.instant("CHIEF_COMPLAINT_DATA_OTHER_CONCEPT_KEY")) {
                    if (this.groupMembers[0].concept.name === this.translate.instant("CHIEF_COMPLAINT_TEXT_KEY")) {
                        return this.translate.instant("CHIEF_COMPLAINT_DATA_WITHOUT_OTHER_CONCEPT_TEMPLATE_KEY", {chiefComplaint: this.groupMembers[0].value, duration: this.groupMembers[1].value, unit: this.groupMembers[2].value.name});
                    }
