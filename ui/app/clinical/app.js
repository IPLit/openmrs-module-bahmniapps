...
angular.module('consultation', ['ui.router', 'bahmni.clinical', 'bahmni.common.config', 'bahmni.common.patient',
    ...
    'bahmni.common.displaycontrol.disposition', 'bahmni.common.displaycontrol.custom', 'bahmni.common.displaycontrol.admissiondetails', 'bahmni.common.displaycontrol.visitAttributes',
    ...
    'bahmni.common.services', 'bahmni.common.models', 'signature']);
angular.module('consultation')
    .config(['$stateProvider', '$httpProvider', '$urlRouterProvider', '$bahmniTranslateProvider', '$compileProvider',
        ...
        // @endif
            ...
            .state('patient.dashboard.show.followup', {
                url: '/follow-up/:conceptSetGroupName',
                params: {
                    cachebuster: null,
                    lastOpenedTemplate: null
                },
                views: {
                    'consultation-content': {
                        templateUrl: 'consultation/views/followup.html',
                        controller: 'ConceptSetPageController'
                    }
                }
            })
