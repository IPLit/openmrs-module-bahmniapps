...
describe('Disposition DisplayControl', function () {
    ...
    //     mockBackend.expectGET('../common/displaycontrols/disposition/views/disposition.html').respond("<div>dummy</div>");
    //    mockBackend.expectGET('/openmrs/ws/rest/v1/bahmnicore/distro/filters/disposition/patientWithLocale?numberOfVisits=4&patientUuid=123456').respond(dispositions);
    ...
    //     mockBackend.expectGET('../common/displaycontrols/disposition/views/disposition.html').respond("<div>dummy</div>");
    //     mockBackend.expectGET('/openmrs/ws/rest/v1/bahmnicore/distro/filters/disposition/patientWithLocale?numberOfVisits=4&patientUuid=123456').respond([]);
